...
enum SubmissionAbility: string implements ScopedAbility
{
     ...
     */
    #[Exposed('Viewer may edit the manuscript — body, file, and title (author, while DRAFT).')]
     ...
     */
    #[Exposed('Viewer may access the manuscript and post comments (while under review).')]
     ...
     * while DRAFT.
     */
    #[Exposed('Viewer may submit this draft for review.')]
    case Submit = 'submission.submit';

    #[Exposed('Viewer may change this submission\'s status (editorial state machine).')]
