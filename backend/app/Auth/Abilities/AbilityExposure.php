 ...
 * part of the public GraphQL contract, their wire names, and their required
 ...
 * resolvers emit granted wire names through it — so the schema and the runtime
 * cannot drift.
 */
final class AbilityExposure
{
    ...
    public static function exposed(string $enum): array
    {
        ...
        foreach ($reflection->getCases() as $case) {
            ...
            $exposed[self::wireName($instance)] = [
                'case' => $instance,
     ...
     */
    public static function wireName(UnitEnum $case): string
    {
