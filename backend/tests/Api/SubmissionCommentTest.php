...
/**
 * Comment retrieval, read-status, author filtering, participants, and the
 * comment edit/delete path (deleteInlineComment / deleteOverallComment /
 * updateInlineComment / updateOverallComment, gated by
 * `@scopedCan(ability: "CommentAbility::Delete" | "CommentAbility::Update")` —
 * the author may revise or retract while review is open).
 *
 * Comment creation and reply coherence are covered by
 * {@see SubmissionIntentMutationsTest} (createInlineComment / createOverallComment);
 * none of these ride the former `updateSubmission` god-mutation any longer.
 */
